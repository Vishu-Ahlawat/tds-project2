...
def generate_cluster_data(df, profile,api_key,output_dir):
    try:
        ...
        n_clusters = 3
        # reason for using 3 clusters and not using llm to get the number of clusters is that i am running low on tokens, and llm is a bit expensive for images.
        # also have to save tokens for stroy narration using vision modelling as i can't manually write sotries in README.md 
